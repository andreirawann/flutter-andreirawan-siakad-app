...
import 'package:flutter_siakad_app/pages/auth/mahasiswa/absensi_page.dart';
import 'package:flutter_siakad_app/pages/auth/mahasiswa/jadwal_matkul.dart';
import 'package:flutter_siakad_app/pages/auth/mahasiswa/khs_page.dart';
import 'package:flutter_siakad_app/pages/auth/mahasiswa/nilai_mk_page.dart';
        ...
        MenuCard(
          ...
          onPressed: () {
            Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const NilaiMkPage(),
                ));
          },
